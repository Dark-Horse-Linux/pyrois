...
mode_build() {
	...
	# TODO: break this into several optional patches
	...
	# this group name length option seems to be arbitrary and unnecessary
	./configure \
		--sysconfdir=/etc \
		--disable-static \
...
mode_install() {
	...
	logprint "Installing manpages."
	make -C man install-man
	assert_zero $?
	
	logprint "Post-Install Configuration..."
	pwconv
	assert_zero $?
